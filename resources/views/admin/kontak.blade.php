...
@section('content')
    <div class="page-wrapper cardhead">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#addKontak" class="btn btn-added"><img
                            src="assets/img/icons/plus.svg" alt="img" class="me-1">Tambah Kontak</a>
                </div>
            </div>
            <!-- /Page Header -->
            @if ($errors->any())
                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                @foreach ($listkontak as $item)
                                        ...
                                        <td>
                                            <a class="me-3" href="#">
                                                <img src="{{ asset('assets') }}/img/icons/edit.svg" alt="img"
                                                    data-bs-toggle="modal" data-bs-target="#editKontak{{ $item->id }}"
                                                    data-toggle="tooltip" data-placement="top" title="EDIT DATA">
                                            </a>
                                            <a class="confirm-text" href="javascript:void(0);"
                                                onclick="confirm_modal('delete-kontak/{{ $item->id }}');">
                                    ...
                                    <!-- MODAL EDIT USERS -->
                                    @include('admin.modaledit.edit-kontak')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    <!-- MODAL -->
    <div class="modal custom-modal fade" id="addKontak">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">FORM INPUT KONTAK</h4>
                    ...
                    <form action="kontak" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-white" placeholder="Masukan Jenis Kontak"
                                type="text" name="jeniskontak" required>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
