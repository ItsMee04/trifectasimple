                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-valid" name="kodeproduk"
                                            value="{{ $listproduk->kodeproduk }}" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="namaproduk" value="{{ $listproduk->namaproduk }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $listproduk->hargaproduk }}" name="hargaproduk" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <select class="select" name="jenisproduk" required>
                                                @foreach ($jenisproduk as $itemjenis)
                                                    <option value="{{ $itemjenis->id }}"
                                                        @if ($listproduk->jenisproduk == $itemjenis->id) selected="selected" @endif>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="beratproduk" value="{{ $listproduk->beratproduk }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="karatproduk" value="{{ $listproduk->karatproduk }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="status" required>
                                                <option value="1"
                                                    @if ($listproduk->status == '1') selected="selected" @endif> AKTIF
                                                </option>
                                                <option value="2"
                                                    @if ($listproduk->status == '2') selected="selected" @endif> TIDAK
                                                    AKTIF</option>
                                            </select>
                                        </div>
                                    </div>
