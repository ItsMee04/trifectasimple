    ...
    <div class="page-wrapper cardhead">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#addIdentitas" class="btn btn-added"><img
                            src="assets/img/icons/plus.svg" alt="img" class="me-1">Tambah Identitas</a>
                </div>
            </div>
            <!-- /Page Header -->
            @if ($errors->any())
                    ...
                    <form action="identitas" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-white" placeholder="Masukan Jenis Identitas"
                                type="text" name="jenisidentitas" required>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
